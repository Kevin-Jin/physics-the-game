...
public class CannonGameMap extends GameMap {
	...
	private static LevelLayout constructLayout() {
		...
		return new LevelLayout(1920, 1080, platforms, new Position(100, 39), new Position(1000, 39), (int) (-9.8 / Game1.METERS_PER_PIXEL), Integer.MIN_VALUE, new ArrayList<OverlayInfo>(), null, "cannonBG", "cannonBG", 90);
	}
