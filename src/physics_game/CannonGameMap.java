...
public class CannonGameMap extends GameMap {
	...
	private static LevelLayout constructLayout() {
		...
		return new LevelLayout(1920, 1080, platforms, new Position(100,0), new Position(1000, 0), (int) (-9.8 / Game1.METERS_PER_PIXEL), -400, new ArrayList<OverlayInfo>(), "", "bg", "bg", 90);
	}
