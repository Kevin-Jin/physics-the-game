...
public class LevelCache {
	...
	private static LevelLayout constructLevel1() {
		...
		return new LevelLayout(1920, 1080, platforms, new Position(100,0), new Position(1000, 0), -400, -400, new ArrayList<BalloonSpawnInfo>(), new ArrayList<OverlayInfo>(), "", "bg", "bg", Double.POSITIVE_INFINITY);
	}
