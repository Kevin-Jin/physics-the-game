...
public class ChargeGameMap extends GameMap {
	...
	private static LevelLayout constructLayout() {
		...
		return new LevelLayout(1920, 1080, platforms, new Position(100, 300), new Position(1140, 300), (int) (-9.8 / Game1.METERS_PER_PIXEL), Integer.MIN_VALUE, new ArrayList<OverlayInfo>(), null, "starBG", "starBG", 90);
	}
